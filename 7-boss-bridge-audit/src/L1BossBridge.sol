...
//report-written the DEPOSIT_LIMIT should be constant.
    ...
    // report written If user 1 has approve this contract to spend money on her behalf then user 2 can drain all of money of user 1 by adding user 1 address on from parameter.
 //report written User 2 can also drain all of the money of the vault.
    ...
    function depositTokensToL2(address from, address l2Recipient, uint256 amount) external whenNotPaused {
        ...
        //report-written Should follow CEI
    ...
    function sendToL1(uint8 v, bytes32 r, bytes32 s, bytes memory message) public nonReentrant whenNotPaused {
        //report-written potential of gas bomb attack
...
//report-written the user can replay the withdrawls
